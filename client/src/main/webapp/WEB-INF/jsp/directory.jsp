...
<div class="directory-container">
    ...
    <div class="container text-center text-md-left">
        <h1 class="directory-heading text-light text-shadow">Directory - Find Influencers</h1>

        <p class="lead pt-1 text-light text-shadow">Find various instagram accounts by different criteria, we've got you covered!</p>
    </div>

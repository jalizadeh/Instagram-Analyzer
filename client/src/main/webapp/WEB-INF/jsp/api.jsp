	...
	<div class="col-md-8 mb-3 mb-md-0">
		...
		<div class="card card-shadow">
			<div class="card-body">
				...
				<div>Here you can find how you can use the API for your
					unlocked reports.</div>

				<hr />

				<span class="text-muted">The API is used to get current
					information of a generated report that is available to your
					account.</span>

				<h5 class="mt-4">API Key</h5>
				<input type="text" class="form-control clickable"
					value="7f1e0a939745860c5889ca2a1078f040" onclick="this.select();">

				<h5 class="mt-4">API Url</h5>
				<input type="text" class="form-control clickable"
					value="https://instaanalyzer.com/api" onclick="this.select();">

				<h5 class="mt-4">URL Format</h5>
				<input type="text" class="form-control clickable"
					value="https://instaanalyzer.com/api?api_key={YOUR_API_KEY}&username={SOURCE_ACCOUNT_USERNAME}&source=instagram"
					onclick="this.select();">
				...
				<span class="text-muted">You are required to specify all
					these params in order to get a valid response.</span>
				...
				<span class="text-muted">The source parameter accepts the
					name of the source of details. (ex: instagram )</span>


				<h5 class="mt-4">Success Response</h5>
				<span class="text-muted">Here is how a sample request
					response should look like.</span>
				...
				<span class="text-muted">Here is how a failed request
					response will look like.</span>
				...
				<pre id="api_sample_response">
{
    ...
    "message": "Your api key is not authorized to make this request."
				...
				<span class="text-muted">A super easy example on how you can
					implement this with PHP.</span>
...
print_r($data);
	...
	<div class="col-md-4">
		...
		<div class="card card-shadow">
			<div class="card-body">
				<h4 class="card-title d-flex justify-content-between">Hey, bro
					🔥</h4>
				<p class="card-text text-muted">
					Here are some useful links below <i class="fa fa-arrow-down"></i>
				</p>
			...
			<div class="list-group">
				<a href="store"
					...
					class="fa fa-credit-card"></i> Store</a> <a href="favorites"
					class="list-group-item list-group-item-action border-0"><i
					class="fa fa-heart"></i> Favorites</a> <a href="account-settings"
					class="list-group-item list-group-item-action border-0 "><i
					class="fa fa-wrench"></i> Account Settings</a> <a
					href="api-documentation"
					class="list-group-item list-group-item-action border-0 active"><i
					class="fab fa-keycdn"></i> API Documentation</a> <a href="logout"
					class="list-group-item list-group-item-action border-0"><i
